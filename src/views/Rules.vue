...
<v-card style="height: 480px; width: 300px; margin-bottom: 55px; padding: 20px; overflow: scroll;">
<v-card-text style="padding: 0">
     <h1>RULES OF PLAY & POLICIES</h1>

     <h2>SPORTSMANSHIP</h2>
         <ul>
           <li> We share the common interest to inspire our children
                 to practice the ideals of sportsmanship and fair play. Any player,
 ...
 <div style="width: 100%; display: flex; justify-content: center;"><img style="height: 100px; width: 100px;" src="@/assets/nysl_logo.png" alt="image_children"> </div>
